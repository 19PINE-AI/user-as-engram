...
every per-user single-substrate baseline we tested.} Per-user LoRA's
\emph{architectural} contamination is base-independent and large; its
\emph{user-visible} reasoning damage is base-dependent and variable;
its replacement by the layered design recovers reasoning while keeping
storage at 88\,KB per user.
