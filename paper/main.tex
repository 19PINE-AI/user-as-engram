...
(Engram), or in a search index (RAG).
\end{abstract}
...
deployed---the view Figure~\ref{fig:pareto} previews and the rest of
the paper makes concrete.
...
The rest of the paper develops four results, each in its own section:
...
\label{app:morefigs}
Supporting figures referenced from the body.
