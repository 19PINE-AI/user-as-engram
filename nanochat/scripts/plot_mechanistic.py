...
def main():
    ...
    p.add_argument("--mechanistic", default="/home/ubuntu/user-as-engram/results/mechanistic_d8.json")
    p.add_argument("--out-dir", default="/home/ubuntu/user-as-engram/results/figs")
    args = p.parse_args()
